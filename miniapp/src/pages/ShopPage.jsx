...
const PERK_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'extraslot', title: '📂 Доп. слот квеста 48ч', price: 2000, blockedBy: 'extraSlotActive', activeUntilField: 'extraSlotUntil', description: 'Позволяет вести до 3 квестов одновременно.' },
