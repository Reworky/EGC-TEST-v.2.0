...
function WithdrawRubForm({ wallet, onDone }) {
  ...
  return (
    <div className="ref-link-card">
      ...
      <p className="shop-desc">Минимум 5 000 EXC. Курс: 1 000 EXC = {Math.round(10 * wallet.healthRatioPercent / 100)} ₽ (фонд {wallet.healthRatioPercent}%). Доступно: {wallet.remainingWithdrawalLimit.toLocaleString()} EXC.</p>
