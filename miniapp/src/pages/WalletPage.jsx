...
function WithdrawRubForm({ wallet, onDone }) {
  ...
  return (
    <div className="ref-link-card">
      ...
      <p className="shop-desc">Минимум 5 000 EXC. Курс: 100 EXC = 1 ₽. Доступно: {wallet.remainingWithdrawalLimit.toLocaleString()} EXC.</p>
...
function WithdrawView({ wallet, onChanged }) {
  ...
  return (
    <>
      <div className="view-toggle" style={{ padding: '0 0 12px' }}>
