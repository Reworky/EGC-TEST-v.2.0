...
public interface QuestRepository extends JpaRepository<Quest, Long> {
    ...
    java.util.Optional<Quest> findFirstByExternalAutoApproveTrueAndActiveTrueAndExternalNetworkAndExternalOfferId(String externalNetwork, String externalOfferId);
}
