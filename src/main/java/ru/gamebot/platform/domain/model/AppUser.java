...
public class AppUser {
    ...
    /** Последний пройденный порог по числу приглашённых друзей, о котором уже прислано уведомление
     *  (Модуль 3 максимизации рефералки). null = ещё не проверяли — тот же паттерн первого замера. */
    private Integer lastNotifiedInvitedFriendsMilestone;
