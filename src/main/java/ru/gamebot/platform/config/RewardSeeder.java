...
public class RewardSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        seedAvatarFrame("🔥 Анимированная огненная рамка",
                "Живая огненная анимация вокруг аватара в профиле мини-аппа. Применяется сразу после покупки.",
                8_000, "#ef4444", "fire_anim");
