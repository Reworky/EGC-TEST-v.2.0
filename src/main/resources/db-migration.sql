...
-- Simplified registration: age and country are now optional (filled from profile edit)
ALTER TABLE app_users ALTER COLUMN age INT NULL;
ALTER TABLE app_users ALTER COLUMN country VARCHAR(255) NULL;
